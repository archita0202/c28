...
var background_music,cannon_explosion,cannonwater,pirate_laugh;
...
function preload() {
  ...
  pirate_laugh = loadSound("assets/pirare_laugh.mp3")
}
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      if (boats[i]) {
        ...
        //check the collision between tower and boat
